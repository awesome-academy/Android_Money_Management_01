...
public class StatisticLastMonthPresenterBase extends BaseStatisticsPresenter {
    ...
    public StatisticLastMonthPresenterBase(IncomeRepository incomeRepository, SpendingRepository spendingRepository, StatisticsContract.View view) {
    ...
    public boolean isMonth(Spending spending) {
        return spending.getMonth().equals(String.valueOf(Calendar.getInstance().get(Calendar.MONTH)));
    }

    @Override
    public boolean isMonth(Income income) {
        return income.getMonth().equals(String.valueOf(Calendar.getInstance().get(Calendar.MONTH)));
    }

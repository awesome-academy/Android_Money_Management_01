...
public class StatisticsAdapter extends FragmentStatePagerAdapter {
    private static final int STATISTICS_LAST_MONTH_POSITION = 1;
    private static final int STATISTICS_THIS_MONTH_POSITION = 0;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case STATISTICS_LAST_MONTH_POSITION:
                return new StatisticsLastMonthFragment().newInstance();
            case STATISTICS_THIS_MONTH_POSITION:
            default:
                return new StatisticsThisMonthFragment().newInstance();
        }
    }
